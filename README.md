...
* no **cmd**:
  * `sqlLocalDb c agendadb` (no meu caso a versao criada foi 12.0.2000.8)
* para **iniciar**:
...
* para **detalhes**:
  ...
  * **copie o pipe** (exemplo do pipe: `np:\\.\pipe\LOCALDB#SH0FA34D\tsql\query`)

### Microsoft Visual Studio Community 2015

Para visualizar os dados e poder executar o SQL, adicione uma connexão com o BD

> Tools > Connect to Database... > Microsoft SQL Server (Data Provider for SQL Server) > Continue

Coloque em Server name: **(localdb)\agendadb** > Test Connection > OK (ou se preferir, pode ser usado o valor do pipe, qualquer dúvida veja o video: https://www.youtube.com/watch?v=VDLQPD2AV_E)
